...
var Browser = function() {
    ...
    if (n) {
        var i = 0;
        if ("Opera" == navigator.appName) i = parseFloat(navigator.appVersion);
        else {
...
function() {
    function e() {
        ...
        function i(e, t) {
            ...
            function(n, i) {
                n ? (console.log("消息发布成功"), o("{ topic: " + e + ", msg:" + t + " }")) : o(i)
            })
        }
        function o(e) {
        ...
        var a = new Yunba({
            ...
            port: 443,
            secure: !0,
            appkey: "58364bdab09557a45c141618" //54d0c26252be1f7e1dd84c43
        }),
        ...
        a.init(function(t) {
            o("正在初始化..."),
            t ? (o("初始化成功..."), e()) : o("初始化失败或服务断线，若长时间无响应请尝试刷新页面")
        },
        function() {
            o("服务断线，正在尝试重新连接..."),
            e()
        ...
        $("#btn-subscribe").click(function() {
            ...
            "" == e ? o("请输入频道名称") : /^[a-zA-Z0-9\_]{1,32}$/.test(e) ? (s = e, n(s), t(s), $("#link-push-demo").attr("href", "/quickstart/push/" + s + "/"), r.makeCode(window.location.href + "push/" + s + "/")) : o("频道名称只能由大小写英文字母、_、与数字组成，不能超过32")
        }),
        $("#btn-send").click(function() {
            var e = $("#input-message").val();
            if (a.socket_connected) i(s, e);
            else {
                var n = "yunba_push_demo_1" + Math.floor(1e5 * Math.random());
                a.connect_by_customid(n,
                function(n, o) {
                    n && (t(s), i(s, e))
                })
            }
    ...
    function t() {
        ...
        s.init(function(e) {
            e ? (o("初始化成功..."), t()) : o("初始化失败或服务断线，若长时间无响应请尝试刷新页面")
        },
        function() {
            o("服务断线，正在尝试重新连接..."),
            t()
    ...
    n.home = function() {
        $(function() {
            function e(t) {
                f || (clearTimeout(c), c = setTimeout(e, 5e3), u.eq(h).fadeOut(function() {
                    void 0 != t ? h = t: h++,
                    h >= m && (h = 0),
            ...
            r();
            var l, d = 0;
            $("#home-video-modal").on("show.bs.modal",
            function() {
            ...
            var c, u = $(".home-slide"),
            p = $(".home-slide-status a"),
            m = u.length,
            h = 0,
            f = !1;
            $(".home-slide-status").delegate("a", "click",
            function(t) {
    ...
    n.products = function(e) {
        "index" == e && $(function() {
            ...
            $(".products-hero").delegate("a", "click",
            function() {
                var n = $(this),
                i = $(n.data("tab"));
            ...
            var n = location.hash; ["#push", "#realtime", "#analytics", "#presence"].indexOf(n) > -1 && $('.products-hero a[href="' + n + '"]').click()
        })
    },
        ...
        $(function() {
            function e(e, t) {
                function n() {
                    var n = +new Date,
                    o = Math.ceil((t - n) / 1e3);
                    o <= 0 ? (e.attr("disabled", !1), window.clearInterval(i), e.find(".count").empty()) : e.find(".count").text("(" + o + ")")
                }
                e.attr("disabled", !0);
            ...
            t.click(function() {
                $.ajax({
                    ...
                    error: function(i) {
                        ...
                        a.email ? ($(".help-block").text(a.email), t.attr("disabled", !1)) : a.verifyTime && (o = new Date(parseInt(a.verifyTime)), $(".help-block").text("发送过于频繁, 请于稍后再发"), e(t, a.verifyTime))
                    }
                })
            });
    ...
    n.doc = function(e) {
        $(function() {
            ...
            o = $(".doc-footer"),
            a = $(".top-bar");
            if ($(window).resize(t), t(), $("#document-tocify").tocify({
                context: ".doc-content",
                selectors: "h2,h3",
                extendPage: !1,
                theme: "none",
    ...
    n.docSearch = function() {
        var e = function(e, t) {
            ...
            g = Math.ceil(n / 10);
            f.html("");
            for (var v = $("<ul></ul>"), r = 0, b = 1; r < g; r++, b++) {
                if (b === i) var w = $("<li></li>").addClass("li-on").text(b);
                else var w = $("<li></li>").text(b);
                v.append(w)
            }
        ...
        t = function(t, n, i) {
            ...
            $.ajax({
                ...
                200 === t.code ? e(t.data, n) : (alert("搜索服务器出错" + t.msg), console.log(t))
            }).fail(function(e, t) {
                console.log(e)
            }).always(function(e) {
        ...
        $(function() {
            if (void 0 !== $("#doc-search-input").val()) $("#doc-search-input").on("keypress",
            function(e) {
                if ("13" == e.keyCode) {
                    var t = $(e.target).val();
                ...
                t(e, 0),
                $("#doc-search-input-type").on("keypress",
                function(e) {
                    if ("13" == e.keyCode) {
                ...
                $(".doc-search-result-pageNum").on("click",
                function(n) {
    ...
    n.comment = function(e) {
                ...
                success: function(e) {
                    if (200 === e.code && e.data) {
                        ...
                        n = 0; n < t.length; n++) {
                            ...
                            d = l[0];
                            l[1];
                            "normal" === t[n].commentGrade ? (i.addClass("user-comment"), o.text(t[n].userName).addClass("comment-user-span"), a.text(" " + d + " \n").addClass("comment-time-span"), s.text(t[n].commentContent).addClass("user-comment-content-span"), i.append(o, a, s)) : (i.addClass("admin-comment"), o.text(t[n].userName).addClass("comment-admin-span"), a.text(" " + d + " \n").addClass("comment-time-span"), s.text(t[n].commentContent).addClass("admin-comment-content-span"), i.append(o, a, s)),
                            $(".doc-comments-list-ul").append(i)
                        }
                    } else $("#comment-loading").hide(),
                    $("#comment-null").show()
                },
                error: function(e) {
                    $("#comment-loading").hide(),
        ...
        $.ajax({
            ...
            success: function(e) {
                if (200 === e.code && e.data.canComment === !0) {
                    n = e.data._id;
                    var t = e.data.com;
                    for (var i in t) $(".yb-comment-all[version=" + i + "]").children().addClass("yb-has-comment-btn").removeClass("yb-comment-btn").children(".yb-comment-arrow").addClass("yb-has-comment-arrow").removeClass("yb-comment-arrow"),
                    $(".yb-comment-all[version=" + i + "]").find("span").text(t[i])
                } else console.log("获取文章信息失败或者禁止评论！mark"),
                $(".yb-comment-all").hide()
            },
            error: function(e) {
                console.log("网络出错")
        ...
        function() {
            if ($("#comment-help-block-err").hide(), $("#comment-help-block-suc").hide(), "" === n) return alert("获取文章信息失败！该文章不允许评论"),
            !1;
            var i = {};
            ...
            $.ajax({
                ...
                data: i,
                beforeSend: function() {
                    if (i.commentContent.length > 200 || 0 === i.commentContent.length) return $("#comment-help-block-err").text("评论不能为空且不能超过200个字符").show(),
                    !1
                },
                success: function(e) {
                    200 !== e.code ? ($("#comment-help-block-err").show(), console.log("提交失败"), console.log(e.msg)) : (t(n, i.tagId), $("#comment-input").val(""))
                },
                error: function(e) {
                    console.log(e),
                    401 === e.status ? $("#comment-help-block-log").show() : ($("#comment-help-block-err").show(), console.log("网络出错：comment"))
                }
            })
        }),
        $(".yb-comment-all").on("click",
        function() {
        ...
        $(function() {
            function e(e) {
                $.ajax({
                    ...
                    success: function(e) {
                        i.attr("disabled", !1),
                        200 === e.code ? (s.text(e.data), window.location.href = "/portal-v2/") : 201 === e.code ? s.text(e.data) : 202 === e.code ? s.text(e.data) : 203 === e.code ? s.text(e.data) : 206 === e.code ? r.text(e.data) : s.text("请求失败请检查网络连接,或者联系管理员")
                    },
                    error: function(e) {
                        i.attr("disabled", !1),
            ...
            function t(e) {
                return l.hide(),
                e.val().trim().length > 16 ? (s.text("用户名请小于16个字符"), !1) : 0 == e.val().trim().length ? (s.text("用户名不能为空"), !1) : !!/^[a-zA-Z0-9\-\_]+$/.test(e.val().trim()) || (s.text("用户名只能是英文字母、数字、'-', '_'组成"), !1)
            }
            function n(e) {
                l.hide();
                var t = e.val().trim(),
                n = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
                return !! n.test(t) || (r.text("邮箱格式不正确"), !1)
            }
            var i = $("#confirmBtn"),
            o = $("#usernameInput"),
            a = $("#emailInput"),
            ...
            function() {
                ...
                s.text(""),
                r.text(""),
                t(o) && n(a) ? (e(d), i.attr("disabled", !0)) : i.attr("disabled", !1)
            })
        })
    },
    n.docHistory = function(e) {
        function t(e) {
            for (var t = $("#docHistory"), n = e.length - 1; n >= 0; n--) t.append("<li><a href=" + e[n].url + ">" + e[n].name + "</a></li>")
        }
        var n = [],
        i = "",
        o = {},
        ...
        window.localStorage ? (n = JSON.parse(r.getItem("yunba_doc_history")), null !== n && t(n), s.on("click",
        function(e) {
            ...
            n.length >= a ? (n = _.rest(n), i = JSON.stringify(n), r.setItem("yunba_doc_history", i)) : (i = JSON.stringify(n), r.setItem("yunba_doc_history", i))
...
function() {
    ...
    app.LoginView = Backbone.View.extend({
        ...
        loginOnEnter: function(e) {
            13 === e.keyCode && (e.preventDefault(), "login-username" !== $(e.target).attr("id") && "login-password" !== $(e.target).attr("id") || this.login())
        },
        login: function() {
            NProgress.start(),
            this.model.save({
...
function() {
    ...
    app.ForgotView = Backbone.View.extend({
        ...
        forgotOnEnter: function(e) {
            13 === e.keyCode && (e.preventDefault(), this.forgot())
        },
        forgot: function() {
            NProgress.start(),
...
function() {
    ...
    app.SignupModalView = Backbone.View.extend({
        ...
        signupOnEnter: function(e) {
            13 === e.keyCode && (e.preventDefault(), "signup-password" !== $(e.target).attr("id") && "signup-repassword" !== $(e.target).attr("id") || this.signup())
        },
        checkTerms: function() {
